...
#             st.write(corr_coeffs)
            ...
            if calorie<avg_calorie:
                w4 = avg_weight-(calorie*(-calorie_cor)*0.001)-3
            else:
